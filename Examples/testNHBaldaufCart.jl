...
Model = CGDycore.Model()
  ...
  Model.NumV=NumV
  Model.NumTr=NumTr
  Model.Problem="BaldaufCart"
  Model.ProfRho="BaldaufCart"
  Model.ProfTheta="BaldaufCart"
  Model.ProfVel="Const"
  Model.RhoPos=1
  Model.uPos=2
  Model.vPos=3
...
# CGDycore.AddVerticalGrid!(Grid,nz,H)
  ...
  Model.HyperDCurl=1.e5
  Model.HyperDGrad=1.e5
  Model.HyperDDiv=1.e5
...
# Output
  ...
  Global.TBGrd=CGDycore.Project(CGDycore.fTBGrd,0.0,CG,Global,Param)
  Global.ThetaBGrd=CGDycore.Project(CGDycore.fThetaBGrd,0.0,CG,Global,Param)

# Output
  Output.vtkFileName=string("BaldaufCart",string(Proc),"_")
  Output.vtk=0
  Output.Flat=true
  Output.H=H
  Output.cNames = [
