...
RadEarth = 1.0
nz = 1
Grid = Grids.TriangularGrid(backend,FTB,RefineLevel,RadEarth,nz)

DG0Tri = DyCore.DG0Struct{FTB}(backend,Grids.Tri(),Grid)
RT0Tri = DyCore.RT0Struct{FTB}(backend,Grids.Tri(),Grid)
