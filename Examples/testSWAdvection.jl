...
if Parallel
  ...
  Exchange = CGDycore.InitExchangeDG(SubGrid,OrdPoly,CellToProc,Proc,ProcNumber,Parallel)
  ...
  (CG,Global)=CGDycore.DiscretizationDG(OrdPoly,OrdPolyZ,CGDycore.JacobiSphere3,Global)
  stop
