...
mul!(hGrad,Grad,h)
@show maximum(abs.(hGrad))
@show maximum(abs.(hGradEx))
@show maximum(abs.(hGrad-hGradEx))
FiniteVolumes.ConvertVelocitySp!(backend,FTB,VelSp,hGrad,Grid)
Outputs.vtkSkeleton!(vtkSkeletonMesh, GridType*"FVOperator", Proc, ProcNumber, [h VelSp], 0, SpeciesList)
FiniteVolumes.ConvertVelocitySp!(backend,FTB,VelSpE,hGradEx,Grid)
Outputs.vtkSkeleton!(vtkSkeletonMesh, GridType*"FVOperator", Proc, ProcNumber, [h VelSpE], 1, SpeciesList)
Outputs.vtkSkeleton!(vtkSkeletonMesh, GridType*"FVOperator", Proc, ProcNumber, [h VelSp-VelSpE], 2, SpeciesList)
for iN = 1 : Grid.NumNodes
  if length(Grid.Nodes[iN].F) == 3
    ...
    @show VelSp[iF1,:]
    @show VelSpE[iF1,:]
    for iE in Grid.Faces[iF1].E
      @show iE,hGrad[iE],hGradEx[iE]
    end  
    iF2 = Grid.Nodes[iN].F[2]
    @show VelSp[iF2,:]
    @show VelSpE[iF2,:]
    for iE in Grid.Faces[iF2].E
      @show iE,hGrad[iE],hGradEx[iE]
    end  
    iF3 = Grid.Nodes[iN].F[3]
    @show VelSp[iF3,:]
    @show VelSpE[iF3,:]
    for iE in Grid.Faces[iF3].E
      @show iE,hGrad[iE],hGradEx[iE]
    end  
  end
end
...
mul!(uT,Tang,uN)
@show maximum(abs.(uT))
@show maximum(abs.(uTEx))
@show maximum(abs.(uT-uTEx))
FiniteVolumes.ConvertVelocityTSp!(backend,FTB,VelSpE,uTEx,Grid)
FiniteVolumes.ConvertVelocityTSp!(backend,FTB,VelSp,uT,Grid)
Outputs.vtkSkeleton!(vtkSkeletonMesh, GridType*"FVOperator", Proc, ProcNumber, [h VelSp], 3, SpeciesList)
Outputs.vtkSkeleton!(vtkSkeletonMesh, GridType*"FVOperator", Proc, ProcNumber, [h VelSpE], 4, SpeciesList)
Outputs.vtkSkeleton!(vtkSkeletonMesh, GridType*"FVOperator", Proc, ProcNumber, [h VelSp-VelSpE], 5, SpeciesList)
for iN = 1 : Grid.NumNodes
  if length(Grid.Nodes[iN].F) == 3
    @show iN
    iF1 = Grid.Nodes[iN].F[1]
...
Outputs.vtkSkeleton!(vtkSkeletonMesh, GridType*"FVOperator", Proc, ProcNumber, [DivEx VelSp], 6, SpeciesList)
Outputs.vtkSkeleton!(vtkSkeletonMesh, GridType*"FVOperator", Proc, ProcNumber, [Div VelSp], 7, SpeciesList)
Outputs.vtkSkeleton!(vtkSkeletonMesh, GridType*"FVOperator", Proc, ProcNumber, [DivEx-Div VelSp], 8, SpeciesList)
...
@. Curl /= DualVolume
@. CurlEx /= DualVolume
Outputs.vtkSkeleton!(vtkSkeletonMesh, GridType*"FVOperator", Proc, ProcNumber, [CurlEx VelSp], 9, SpeciesList)
Outputs.vtkSkeleton!(vtkSkeletonMesh, GridType*"FVOperator", Proc, ProcNumber, [Curl VelSp], 10, SpeciesList)
Outputs.vtkSkeleton!(vtkSkeletonMesh, GridType*"FVOperator", Proc, ProcNumber, [CurlEx-Curl VelSp], 11, SpeciesList)
...
Outputs.vtkSkeleton!(vtkSkeletonMesh, GridType*"FVOperator", Proc, ProcNumber, [hEx VelSp], 12, SpeciesList)
Outputs.vtkSkeleton!(vtkSkeletonMesh, GridType*"FVOperator", Proc, ProcNumber, [h VelSp], 13, SpeciesList)
Outputs.vtkSkeleton!(vtkSkeletonMesh, GridType*"FVOperator", Proc, ProcNumber, [h - hEx VelSp], 14, SpeciesList)
