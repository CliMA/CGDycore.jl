...
Flat = false
GridHealpix = Grids.HealpixGrid(backend,FTB,ns,Rad,nz)
vtkSkeletonMeshHealpix = Outputs.vtkStruct{Float64}(backend,GridHealpix,GridHealpix.NumFaces,Flat)
c = ones(FTB,GridHealpix.NumFaces)
for i = 1 : GridHealpix.NumFaces
  c[i] = i
end  
FileNumber = 1
@show GridHealpix.NumFaces
Outputs.vtkSkeleton!(vtkSkeletonMeshHealpix,"Healpix", 1, 1,c,FileNumber)
