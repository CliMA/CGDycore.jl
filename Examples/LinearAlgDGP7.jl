import CGDycore:
  Thermodynamics, Examples, Sources, Parallels, Models, Grids, Surfaces,  Outputs, Integration, 
  FiniteElements, DGVertical, GPU, DyCore, DGSEM
using MPI
using Base
using CUDA
using AMDGPU
...
GeoPotential = Sources.GeoPotentialDeep()(2,Grid.Form)
