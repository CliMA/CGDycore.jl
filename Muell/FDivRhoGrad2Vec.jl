...
vC2 = TCacheC4[Threads.threadid()]
  ...
  @views @. grad1CG = dXdxIC[:,:,1,1] * D1cCG + dXdxIC[:,:,2,1] * D2cCG[:,:]
  @views @. grad2CG = dXdxIC[:,:,1,2] * D1cCG + dXdxIC[:,:,2,2] * D2cCG[:,:]

  @views @. D1gradCG = dXdxIC[:,:,1,1] * grad1CG + dXdxIC[:,:,1,2] * grad2CG[:,:]
  @views @. D2gradCG = dXdxIC[:,:,2,1] * grad1CG + dXdxIC[:,:,2,2] * grad2CG[:,:]
