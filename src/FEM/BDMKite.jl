mutable struct BDMKiteDualHDiv{FT<:AbstractFloat,
...
function BDMKiteDualHDiv{FT}(k,::Grids.Quad,backend,Grid) where FT<:AbstractFloat
  DoF, DoFE, DoFF, phi, Divphi = FEM.ConstructBDM(k,Grids.Quad())
  DoFN = 0
