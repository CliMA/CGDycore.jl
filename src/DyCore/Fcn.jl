function FcnPrepare!(U,CG,Metric,Cache,Global,Param,DiscType::Val{:VectorInvariant})
(;  RhoPos,
    uPos,
    vPos,
    wPos,
...
function Fcn!(F,U,CG,Metric,Cache,Global,Param,DiscType::Val{:VectorInvariant})
