...
#SBATCH --output=output/Timing/BaroWaveDGQuad_20Elem   # File name for standard output
...
srun -n 1 gpu_wrapper.sh -n 1 -e "./Jobs/NHSphere/DG/BaroWaveDrySphereDGQuad_20Elem"
