...
#SBATCH --output=output/Timing/BaroWaveDGQuad_40Elem   # File name for standard output
...
srun -n 4 gpu_wrapper.sh -n 4 -e "./Jobs/NHSphere/DG/BaroWaveDrySphereDGQuad_40Elem"
