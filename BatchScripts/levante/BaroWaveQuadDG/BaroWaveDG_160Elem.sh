...
#SBATCH --output=output/Timing/BaroWaveDGQuad_160Elem   # File name for standard output
...
srun -n 64 gpu_wrapper.sh -n 64 -e "./Jobs/NHSphere/DG/BaroWaveDrySphereDGQuad_160Elem"
