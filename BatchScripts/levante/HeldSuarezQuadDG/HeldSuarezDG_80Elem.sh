...
#SBATCH --output=output/Timing/HeldSuarezDGQuad_80Elem   # File name for standard output
...
srun -n 16 gpu_wrapper.sh -n 16 -e "./Jobs/NHSphere/DG/HeldSuarezDrySphereDGQuad_80Elem"
