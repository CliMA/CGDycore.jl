...
#SBATCH --output=output/Timing/HeldSuarezDGQuad_160Elem   # File name for standard output
...
srun -n 64 gpu_wrapper.sh -n 64 -e "./Jobs/NHSphere/DG/HeldSuarezDrySphereDGQuad_160Elem"
