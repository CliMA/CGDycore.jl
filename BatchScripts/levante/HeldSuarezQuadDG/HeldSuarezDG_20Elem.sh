...
#SBATCH --output=output/Timing/HeldSuarezDGQuad_20Elem   # File name for standard output
...
srun -n 4 gpu_wrapper.sh -n 4 -e "./Jobs/NHSphere/DG/HeldSuarezDrySphereDGQuad_20Elem"
