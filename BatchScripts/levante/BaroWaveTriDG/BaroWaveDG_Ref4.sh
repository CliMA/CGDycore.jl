...
#SBATCH --output=output/Timing/BaroWaveDGTri_Ref4   # File name for standard output
...
srun -n 1 gpu_wrapper.sh -n 1 -e "./Jobs/NHSphere/DG/BaroWaveDrySphereDGTri_Ref4"
