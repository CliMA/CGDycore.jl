...
#SBATCH --output=output/Timing/BaroWaveDGTri_Ref5   # File name for standard output
...
srun -n 4 gpu_wrapper.sh -n 4 -e "./Jobs/NHSphere/DG/BaroWaveDrySphereDGTri_Ref5"
