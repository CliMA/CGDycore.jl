...
#SBATCH --output=output/Timing/BaroWaveDGTri_Ref8   # File name for standard output
...
srun -n 256 gpu_wrapper.sh -n 256 -e "./Jobs/NHSphere/DG/BaroWaveDrySphereDGTri_Ref8"
