...
#SBATCH --output=output/Timing/BaroWaveDGTri_Ref7   # File name for standard output
...
srun -n 64 gpu_wrapper.sh -n 64 -e "./Jobs/NHSphere/DG/BaroWaveDrySphereDGTri_Ref7"
