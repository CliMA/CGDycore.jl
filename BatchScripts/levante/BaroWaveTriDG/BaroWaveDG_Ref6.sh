...
#SBATCH --output=output/Timing/BaroWaveDGTri_Ref6   # File name for standard output
...
srun -n 16 gpu_wrapper.sh -n 16 -e "./Jobs/NHSphere/DG/BaroWaveDrySphereDGTri_Ref6"
