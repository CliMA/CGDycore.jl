...
#SBATCH --time=00:59:00            # Set a limit on the total run time
#SBATCH --mail-type=FAIL           # Notify user by email in case of job failure
#SBATCH --account=bb1143           # Charge resources on this project account
#SBATCH --output=BaroWaveDGTri_32Elem   # File name for standard output
...
srun -n 4 gpu_wrapper.sh -n 4 -e "./Jobs/NHSphere/BaroWaveDrySphereDGTri_32Elem"
