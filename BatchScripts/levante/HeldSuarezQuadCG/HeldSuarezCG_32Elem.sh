...
#SBATCH --output=output/Timing/HeldSuarezCGQuad_32Elem   # File name for standard output
...
srun -n 1 gpu_wrapper.sh -n 1 -e "./Jobs/NHSphere/CG/HeldSuarezDrySphereCGQuad_32Elem"
