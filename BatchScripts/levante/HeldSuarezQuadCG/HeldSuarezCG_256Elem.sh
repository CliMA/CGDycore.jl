...
#SBATCH --output=output/Timing/HeldSuarezCGQuad_256Elem   # File name for standard output
...
srun -n 64 gpu_wrapper.sh -n 64 -e "./Jobs/NHSphere/CG/HeldSuarezDrySphereCGQuad_256Elem"
