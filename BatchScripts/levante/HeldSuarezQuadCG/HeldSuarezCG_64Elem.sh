...
#SBATCH --output=output/Timing/HeldSuarezCGQuad_64Elem   # File name for standard output
...
srun -n 4 gpu_wrapper.sh -n 4 -e "./Jobs/NHSphere/CG/HeldSuarezDrySphereCGQuad_64Elem"
