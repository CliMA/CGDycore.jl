...
#SBATCH --output=output/Timing/HeldSuarezCGQuad_128Elem   # File name for standard output
...
srun -n 16 gpu_wrapper.sh -n 16 -e "./Jobs/NHSphere/CG/HeldSuarezDrySphereCGQuad_128Elem"
