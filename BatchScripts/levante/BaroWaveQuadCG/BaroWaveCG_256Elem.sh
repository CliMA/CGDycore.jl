...
#SBATCH --output=output/Timing/BaroWaveCGQuad_256Elem   # File name for standard output
...
srun -n 64 gpu_wrapper.sh -n 64 -e "./Jobs/NHSphere/CG/BaroWaveDrySphereCGQuad_256Elem"
