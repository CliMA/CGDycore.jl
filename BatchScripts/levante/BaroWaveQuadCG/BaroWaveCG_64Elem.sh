...
#SBATCH --output=output/Timing/BaroWaveCGQuad_64Elem   # File name for standard output
...
srun -n 4 gpu_wrapper.sh -n 4 -e "./Jobs/NHSphere/CG/BaroWaveDrySphereCGQuad_64Elem"
