      ...
      @inbounds for ix = 1 : Nx
        if iy > 1
          @inbounds for i = 1 : OPx
            cM = c[ix,iy-1,iz,i,OPy] + c[ix,iy,iz,i,1]
            JRM = JRho[ix,iy-1,iz,i,OPy] + JRho[ix,iy,iz,i,1]
            c[ix,iy-1,iz,i,OPy] = cM
            c[ix,iy,iz,i,1] = cM
            JRho[ix,iy-1,iz,i,OPy] = JRM
            JRho[ix,iy,iz,i,1] = JRM
          end
        else
          @inbounds for i = 1 : OPx
            cM = c[ix,Ny,iz,i,OPy]+ c[ix,iy,iz,i,1]
            JRM = JRho[ix,Ny,iz,i,OPy] + JRho[ix,iy,iz,i,1]
            c[ix,Ny,iz,i,OPy] = cM
            c[ix,iy,iz,i,1] = cM
            JRho[ix,Ny,iz,i,OPy] = JRM
            JRho[ix,iy,iz,i,1] = JRM
          end
        end
      end
